...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Kelola Testimoni</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Daftar Testimoni</h4>
                <div class="flex-shrink-0">
                    <a href="{{ route('testimonials.create') }}" class="btn btn-success"><i
                            class="ri-add-line align-bottom me-1"></i> Tambah Testimoni</a>
                </div>
            </div>
            <div class="card-body">
                @if(session('success'))
                    ...
                    <table id="testimonialsTable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><i class="ri-star-fill text-warning"></i> {{ $testimonial->rating }}</td>
