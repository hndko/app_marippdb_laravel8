...
<head>
    ...
    <meta content="PPDB App" name="description" />
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free PPDB account now</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Mari PPDB. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                Mari Partnet
                            </p>
                        </div>
                    </div>
